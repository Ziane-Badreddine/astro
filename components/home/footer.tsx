...
const docs = pages.filter((page) => page.url.includes("/docs")).slice(0, 5);
const blogs = pages.filter((page) => page.url.includes("/blogs")).slice(0, 5);
      ...
      <div className="container mx-auto flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div className="col-span-2 max-w-md space-y-4">
            <Link href="/en" className="flex items-center gap-2 font-bold">
              <Logo />
            </Link>
